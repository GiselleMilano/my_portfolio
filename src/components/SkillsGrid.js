export default function SkillsGrid() {
  return (
    ...
    >
      ...
      <ul className="grid xl:grid-cols-6 lg:grid-cols-6 md:grid-cols-3 grid-cols-2 pl-8 pr-8 xl:pr-0 lg:pr-0 xl:pl-0 lg:pl-0 items-center justify-center gap-3">
